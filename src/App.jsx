...
// ─── Defaults ─────────────────────────────────────────────────────────────────
const DEFAULT_SETTINGS = { price13: 150, price16: 180, dotPrice: 0.07, paperPrice: 30, businessName: "Nova Accountings", businessSubtitle: "Laser & CNC Sheet Billing", footerText: "Generated by Nova Accountings", qrCodeData: "", gstPercent: 0 };
      ...
      <div className="settings-grid">
        ...
        <div className="settings-card" style={{gridColumn:"1 / -1"}}>
          ...
          <div className="invoice-format-grid">
            ...
            <div className="settings-field">
              <label>QR Code Data (UPI ID / Payment Link)</label>
              <input type="text" value={form.qrCodeData||""} placeholder="e.g. upi://pay?pa=yourname@upi" onChange={e=>setTxt("qrCodeData",e.target.value)}/>
            </div>
          </div>
