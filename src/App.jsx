...
// ─── Defaults ─────────────────────────────────────────────────────────────────
const DEFAULT_SETTINGS = { price13: 150, price16: 180, dotPrice: 0.07, paperPrice: 30, businessName: "Nova Accountings", businessSubtitle: "Laser & CNC Sheet Billing", footerText: "Generated by Nova Accountings", qrCodeData: "", qrCodeImage: "", gstPercent: 0, pdfFilename: "" };
      ...
      <div className="settings-grid">
        ...
        <div className="settings-card" style={{gridColumn:"1 / -1"}}>
          ...
          <div className="invoice-format-grid">
            ...
            <div className="settings-field" style={{gridColumn:"1 / -1"}}>
              <label>Default PDF Filename</label>
              <input type="text" value={form.pdfFilename||""} placeholder='e.g. Nova-Invoice (leave blank for "invoice")' onChange={e=>setTxt("pdfFilename",e.target.value)}/>
            </div>
            <div className="settings-field">
...
function AddEntryModal({ onClose, onAdd, onEdit, settings, customer, initial }) {
  ...
  const [paper, setPaper]         = useState(initial?.paper !== undefined ? initial.paper : false);
