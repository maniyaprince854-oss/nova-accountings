      ...
      <div className="bill-modal">
        <div style={{background:"var(--surface)",padding:"14px 20px",borderBottom:"1px solid var(--border)",display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
          ...
          <div style={{display:"flex",border:"1px solid var(--border2)",borderRadius:"var(--radius)",overflow:"hidden",flexShrink:0}}>
            <button onClick={()=>setLang("en")} style={{padding:"5px 11px",fontSize:12,fontWeight:700,fontFamily:"IBM Plex Mono",border:"none",cursor:"pointer",background:lang==="en"?"var(--accent)":"var(--surface2)",color:lang==="en"?"#000":"var(--text2)",transition:"all .15s"}}>EN</button>
            <button onClick={()=>setLang("gu")} style={{padding:"5px 11px",fontSize:12,fontWeight:700,fontFamily:"Noto Sans Gujarati,sans-serif",border:"none",borderLeft:"1px solid var(--border2)",cursor:"pointer",background:lang==="gu"?"var(--accent)":"var(--surface2)",color:lang==="gu"?"#000":"var(--text2)",transition:"all .15s"}}>ગુ</button>
          </div>
