      ...
      <div className="bill-modal">
        ...
        <div ref={billRef} className="bill-page">
          ...
          <div className="bill-summary">
            {gstPct > 0
              ? <div className="bill-sum-row"><span>Sub-total</span><span>₹{billTotal.toLocaleString("en-IN",{minimumFractionDigits:2})}</span></div>
            ...
            {gstPct > 0 && <>
              <div className="bill-sum-row"><span>GST ({gstPct}%)</span><span>₹{gstAmount.toLocaleString("en-IN",{minimumFractionDigits:2})}</span></div>
              <div className="bill-sum-row total"><span>Grand Total</span><span>₹{grandTotal.toLocaleString("en-IN",{minimumFractionDigits:2})}</span></div>
            </>}
            {billMonth==="all" && <>
          ...
          {qrDataUrl && (
            <div style={{display:"flex",alignItems:"flex-start",gap:16,margin:"20px 0",padding:"16px",background:"#f9f9f9",borderRadius:8,border:"1px solid #eee"}}>
              ...
              <div style={{display:"flex",flexDirection:"column",justifyContent:"center",gap:4}}>
                <div style={{fontSize:11,fontWeight:700,letterSpacing:"0.1em",textTransform:"uppercase",color:"#888",fontFamily:"'IBM Plex Mono',monospace"}}>Scan to Pay</div>
